...
Trying to package GOGS/Gitea for Debian-main turned out to be a huge mistake. It
is a moving target with a development team that is more concerned about features
over stability, security, and/or documentation.

This page documents my efforts, which were ultimately in vain.
