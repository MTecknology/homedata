...
def parse_id(minion_id=None):
    ...
    >>> parse_id('prd-pubweb-35.core.domain.tld')
    {'cluster_name': 'pubweb', 'cluster_member': False, 'service_level': 'prd', 'cluster_id': '', 'host_id': '35'}
    >>> parse_id('prd-pubweb4-35.core.domain.tld')
    {'cluster_name': 'pubweb', 'cluster_member': True, 'service_level': 'prd', 'cluster_id': '4', 'host_id': '35'}
    '''
    if not minion_id:
...
def app_group_from_id(minion_id):
    ...
    >>> app_group_from_id('prd-ns-01.core.domain.tld')
    prd_ns
    >>> app_group_from_id('prd-pubweb4-35.core.domain.tld')
    'prd_pubweb4'
    '''
